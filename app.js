(function () {
  ...
  const PORTRAITS = {
    ...
    yousef: `<svg viewBox="0 0 100 100"><rect width="100" height="100" fill="var(--manila-dark)"/><path d="M20 100c0-18 13-30 30-30s30 12 30 30z" fill="var(--brass)"/><circle cx="50" cy="40" r="20" fill="#D9AE82"/><path d="M30 34a20 20 0 0140-2c0-10-9-18-20-18s-20 8-20 18z" fill="#241C14"/><path d="M42 74l8 8 8-8" fill="none" stroke="var(--paper)" stroke-width="2"/></svg>`,
    reem: `<svg viewBox="0 0 100 100"><rect width="100" height="100" fill="var(--manila-dark)"/><path d="M22 100c0-18 13-30 28-30s28 12 28 30z" fill="var(--red)"/><path d="M50 14c-16 0-26 12-26 28 0 10 4 18 10 24h32c6-6 10-14 10-24 0-16-10-28-26-28z" fill="var(--gold)"/><circle cx="50" cy="42" r="16" fill="#D9AE82"/></svg>`,
    faisal: `<svg viewBox="0 0 100 100"><rect width="100" height="100" fill="var(--manila-dark)"/><path d="M20 100c0-18 13-30 30-30s30 12 30 30z" fill="var(--gold)"/><circle cx="50" cy="40" r="20" fill="#D9AE82"/><path d="M30 32a20 20 0 0140 0v-2c0-10-9-18-20-18s-20 8-20 18z" fill="#1C1408"/><path d="M42 74l8 8 8-8" fill="none" stroke="var(--paper)" stroke-width="2"/></svg>`,
    mona: `<svg viewBox="0 0 100 100"><rect width="100" height="100" fill="var(--manila-dark)"/><path d="M22 100c0-18 13-30 28-30s28 12 28 30z" fill="var(--red)"/><path d="M50 14c-16 0-26 12-26 28 0 10 4 18 10 24h32c6-6 10-14 10-24 0-16-10-28-26-28z" fill="var(--brass)"/><circle cx="50" cy="42" r="16" fill="#D9AE82"/></svg>`,
    bader: `<svg viewBox="0 0 100 100"><rect width="100" height="100" fill="var(--manila-dark)"/><path d="M20 100c0-18 13-30 30-30s30 12 30 30z" fill="var(--green-light)"/><circle cx="50" cy="40" r="20" fill="#D9AE82"/><path d="M30 34a20 20 0 0140-2c0-10-9-18-20-18s-20 8-20 18z" fill="#332211"/><path d="M42 74l8 8 8-8" fill="none" stroke="var(--paper)" stroke-width="2"/></svg>`,
    sarah: `<svg viewBox="0 0 100 100"><rect width="100" height="100" fill="var(--manila-dark)"/><path d="M22 100c0-18 13-30 28-30s28 12 28 30z" fill="var(--gold)"/><path d="M50 14c-16 0-26 12-26 28 0 10 4 18 10 24h32c6-6 10-14 10-24 0-16-10-28-26-28z" fill="var(--red)"/><circle cx="50" cy="42" r="16" fill="#D9AE82"/></svg>`,
  };
