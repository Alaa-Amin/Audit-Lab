  ...
  'procurement-po-split': {
    ...
    personas: {
      ahmad: {
        ...
        hint: { en: "Ask him directly whether splitting the three POs the same day, to the same vendor, was deliberate to avoid a higher approval level.", ar: "اسأله مباشرة عمّا إذا كان تقسيم أوامر الشراء الثلاثة في نفس اليوم لنفس المورد كان متعمداً لتجنّب مستوى اعتماد أعلى." },
        system:
      ...
      fatima: {
        ...
        hint: { en: "Ask her how she checks for duplicate vendors or dates when approving multiple POs.", ar: "اسألها كيف تتحقق من تكرار المورد أو التاريخ عند اعتماد عدة أوامر شراء." },
        system:
  ...
  'payroll-ghost-employee': {
    ...
    personas: {
      noor: {
        name: 'Noor Al-Fahad',
        role: 'HR Coordinator',
        hint: { en: "Ask her directly whether she was the one who changed his bank account details after his termination.", ar: "اسأليها مباشرة إن كانت هي من غيّرت بيانات حسابه البنكي بعد إنهاء خدمته." },
        system:
      ...
      hamad: {
        ...
        hint: { en: "Ask him how he verifies an employee's active/inactive status before running payroll.", ar: "اسأله كيف يتحقق من حالة الموظف (نشط/غير نشط) قبل تنفيذ صرف الرواتب." },
        system:
  ...
  'inventory-writeoff-fraud': {
    ...
    personas: {
      yousef: {
        ...
        hint: { en: "Ask him directly where the stock from his write-offs actually ends up, since none of them have a destruction record.", ar: "اسأله مباشرة إلى أين تذهب البضاعة فعلياً في عمليات الشطب، بما أنه لا يوجد سجل إتلاف لأي منها." },
        system:
      ...
      reem: {
        ...
        hint: { en: "Ask her whether she independently verifies destruction for write-offs under the KD 700 threshold.", ar: "اسأليها إن كانت تتحقق بشكل مستقل من الإتلاف في عمليات الشطب التي تقل عن 700 د.ك." },
        system:
  ...
  'it-change-management': {
    ...
    personas: {
      faisal: {
        ...
        hint: { en: "Ask him directly who created the FRIEND90 code and who has been using it, not just about the missing change ticket.", ar: "اسأله مباشرة من الذي أنشأ كود FRIEND90 ومن يستخدمه، وليس فقط عن طلب التغيير المفقود." },
        system:
      ...
      mona: {
        ...
        hint: { en: "Ask her how deployments are normally reviewed before reaching production on such a small team.", ar: "اسأليها كيف تتم مراجعة عمليات النشر عادةً قبل وصولها لبيئة الإنتاج في فريق صغير." },
        system:
  ...
  'revenue-credit-note-fraud': {
    ...
    personas: {
      bader: {
        ...
        hint: { en: "Name the exact number of credit notes with no matching Goods Return Note, and ask directly whether he has personally received anything from the customer.", ar: "اذكر العدد الدقيق لإشعارات الدائن التي لا يوجد لها إشعار استلام مطابق، واسأله مباشرة إن كان قد تلقى أي مبلغ شخصياً من العميل." },
        system:
      ...
      sarah: {
        ...
        hint: { en: "Ask her what happens when a credit note is marked 'urgent', and whether that skips any verification step.", ar: "اسأليها ماذا يحدث عندما يُصنَّف إشعار الدائن بأنه 'عاجل' وهل هذا يتجاوز أي خطوة تحقق." },
        system:
